...
<div class="md:flex md:items-center">
    <div class="md:w-1/2 px-10">
        <form id="dropzone" class="dropzone border-dashed border-2 w-full h-96 rounded flex flex-col justify-center items-center" action="{{ route('imagenes.store') }}" enctype="multipart/form-data">
            @csrf
        </form>
    </div>
    <div class="md:w-1/2 p-10 bg-white rounded-lg shadow-xl mt-10 md:mt-0">
        <form action="{{ route('posts.store') }}" method="POST">
            @csrf
            <div class="mb-5">
                <label for="titulo" id="titulo" class="m-2 block uppercase text-gray-500 font-bold">
                    Nombre
                </label>
            ...
            <div class="mb-5">
                <label for="descripcion" id="descripcion" class="m-2 block uppercase text-gray-500 font-bold">
                    Descripción
                </label>
